/**
 * EvidencePanel - Evidence & Validation with inline tool rendering
 */
...
const TOOLS = ["FalsificationPrompts", "PeerReviewSimulator", "ContradictionFinder", "ConsistencyChecker"];

export function EvidencePanel({ activeTool, onOpenTool, onCloseTool, segments }: Props) {
  if (activeTool) {
    return (
