...
export default function SegmentDetails() {
  ...
  const tourSteps = [
    {
      ...
      body: "This is where you inspect individual segments extracted from your documents. From here you can review, refine, and manage each piece of your research before using it in the Thinking Workspace.",
      ref: null as React.RefObject<HTMLDivElement | null> | null,
    },
    {
      key: "header",
      title: "Navigation & Context",
      body: "Use the header to return to the document workspace or navigate to related segments. The breadcrumb trail shows where this segment fits in your document hierarchy.",
      ref: tourRefs.header,
    },
    {
      key: "details",
      title: "Content & Metadata",
      body: "Review the segment text, type classification, and position within the source document. This metadata feeds into search results, slot comparisons, and the knowledge graph.",
      ref: tourRefs.details,
    },
    {
      key: "actions",
      title: "Edit & Manage",
      body: "Refine manual segments by editing boundaries or content. Changes here propagate to search indexes and any workspace slots referencing this segment.",
  ...
  const {
    ...
    storageKey: "segmentDetailsTourSeen",
    steps: tourSteps,
      ...
      {!seg ? null : (
        <div
          ...
          style={{
            ...
            ...(getTourHighlightStyle(tourRefs.details) || {}),
          }}
        >
