...
/**
 * Filter presets with descriptions and examples
 */
export const FILTER_PRESETS = {
  all: { 
    name: "All Segments", 
    description: "Show all segments without any filters",
    example: "Use this to reset all filters",
    filters: {} 
  },
  recent: { 
    name: "Recent (Last 7 Days)", 
    description: "Show segments created in the last 7 days",
    example: "Useful for finding recently added content",
    filters: { 
      dateFrom: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000) // Last 7 days
    } 
  },
  long: { 
    name: "Long Segments (500+ chars)", 
    description: "Show segments with at least 500 characters",
    example: "Great for finding detailed explanations or extensive content",
    filters: { 
      minLength: 500 
    } 
  },
  short: { 
    name: "Short Segments (<200 chars)", 
    description: "Show segments with less than 200 characters",
    example: "Useful for finding quick notes, titles, or brief definitions",
    filters: { 
      maxLength: 200 
    } 
  },
  manual: { 
    name: "Manual Only", 
    description: "Show only manually created/edited segments",
    example: "Find segments you've manually added or modified",
    filters: { 
  ...
  auto: { 
    name: "Auto Only", 
    description: "Show only auto-generated segments from segmentation",
    example: "View original segmentation results before manual edits",
    filters: { 
